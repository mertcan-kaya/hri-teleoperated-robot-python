...
# Modified by Mertcan Kaya (2023-06-21)
...
##        marker_pos_zero = marker_pos_try-marker_pos_ini
##        marker_pos_
        
        #marker_pos_raw_zero = marker_pos_raw-marker_pos_raw_ini
